    ...
    return (
        <>
            <p style={{ wordBreak: "keep-all" }}>
                개인정보 처리 방침<br /><br />
                1. 개인정보 처리방침이란?<br />
                주식회사 스페이스(이하"회사")는 이용자의 ‘동의를 기반으로 개인정보를 수집·이용 및 제공’하고 있으며, ‘이용자의 권리 (개인정보 자기결정권)를 적극적으로 보장’합니다.<br />
                ...
                본 개인정보처리방침은 회사가 제공하는 스페이스 계정 기반의 서비스(이하 ‘서비스'라 함)에 적용됩니다<br /><br />
                ...
                [스페이스 계정]<br />
                필수<br />
                이메일, 비밀번호, 이름(닉네임), 프로필사진, 연락처, 주소, 생년월일<br />
                ...
                회원 가입 시 또는 서비스 이용 과정에서 홈페이지 또는 개별 프로그램 등을 통해 아래와 같이 서비스 제공을 위해 필요한 최소한의 개인정보를 수집하고 있습니다.<br />
                ...
                서비스 이용 기록, 접속 빈도 및 서비스 이용에 대한 통계, 프라이버시 보호 측면의 서비스 환경 구축, 서비스 개선에 활용<br /><br />
                ...
                안내메일 발송 및 CS문의 대응을 위해 스페이스 계정과 탈퇴안내 이메일 주소를 암호화하여 보관<br />
                서비스 부정이용 기록<br /><br />
                ...
                법률이나 서비스의 변경사항을 반영하기 위한 목적 등으로 개인정보처리방침을 수정할 수 있습니다. 개인정보처리방침이 변경되는 경우 스페이스는 변경 사항을 게시하며, 변경된 개인정보처리방침은 게시한 날로부터 7일 후부터 효력이 발생합니다.<br />
